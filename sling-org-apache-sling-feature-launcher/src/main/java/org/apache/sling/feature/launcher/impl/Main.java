...
public class Main {
    ...
    private static void parseArgs(final LauncherConfig config, final String[] args) {
        ...
        final Option cacheOnlyOption = new Option("cacheOnly", false, "Cache only the required dependencies. Don't start the framework.");
        cacheOnlyOption.setArgs(0);
        ...
        options.addOption(cacheOnlyOption);
        ...
        try {
            ...
            if ( cl.hasOption(cacheOnlyOption.getOpt()) ) {
